...
The browser uses the Supabase **publishable** key. That key is designed to be public and is protected by row-level security. Never put a secret or `service_role` key in `index.html`, `app-v5.js`, Storage, or GitHub.
