...
const QUEST_MARKS = [
  { key: "tent", label: "Tent", center: 30.62, centerY: 62.12 },
  { key: "paddle-ball", label: "Flashlight", center: 90.87, centerY: 62.62 },
  { key: "party-popper", label: "Party popper", center: 155.12, centerY: 62.62 },
  { key: "bowl", label: "Cowboy hat", center: 224.87, centerY: 62.37 },
  { key: "beer-mug", label: "Beer mug", center: 295.5, centerY: 60.5 },
  { key: "sparkles", label: "Sparkles", center: 348.37, centerY: 61.25 },
  { key: "gift", label: "Portal", center: 403.37, centerY: 62.62 },
  { key: "key", label: "Key", center: 461.62, centerY: 63.25 },
  { key: "finish-flag", label: "Finish flag", center: 520.5, centerY: 63.25 },
  { key: "skull", label: "Paw print", center: 581.62, centerY: 61.75 },
  { key: "bicycle", label: "Bicycle", center: 646.99, centerY: 65 },
  { key: "lounge-chair", label: "Lounge chair", center: 721.12, centerY: 59.87 },
  { key: "ghost", label: "Secret emoji", center: 784.62, centerY: 63.62 },
  { key: "dice", label: "Dice", center: 849.12, centerY: 63.12 },
  { key: "music-note", label: "Music note", center: 913.37, centerY: 63.25 },
  { key: "taco", label: "Skateboard", center: 981.49, centerY: 66.12 },
  { key: "apple", label: "Apple", center: 1043.12, centerY: 59.87 },
  { key: "artist-palette", label: "Artist palette", center: 1100.49, centerY: 62.12 },
  { key: "typewriter", label: "Scroll", center: 1158.99, centerY: 62 },
  { key: "baseball", label: "Baseball", center: 1218.74, centerY: 64.12 },
  { key: "sword", label: "Sword", center: 1271.36, centerY: 64 },
  { key: "mushroom", label: "Mushroom", center: 1324.61, centerY: 65.5 },
  { key: "dumbbell", label: "Dumbbell", center: 1384.36, centerY: 64.25 },
  { key: "market-bag", label: "Coin purse", center: 1438.49, centerY: 65.25 },
  { key: "craft-tools", label: "Pointer finger", center: 1482.74, centerY: 63.25 },
  { key: "table-tennis", label: "Paddle", center: 1532.11, centerY: 63.37 },
  { key: "cheese", label: "Compass", center: 1592.61, centerY: 62.75 },
  { key: "hot-dog", label: "Hot dog", center: 1647.11, centerY: 64.62 },
  { key: "map", label: "Gem", center: 1704.61, centerY: 62.25 },
  { key: "bird", label: "Bird", center: 1760.98, centerY: 65.12 },
  { key: "cooking-pot", label: "Pottery", center: 1817.86, centerY: 65.25 },
  { key: "arcade", label: "Treasure", center: 1878.11, centerY: 66.25 },
  { key: "ship", label: "Boat", center: 1944.86, centerY: 62.25 },
  { key: "lightning", label: "Lightning", center: 2006.86, centerY: 63.25 },
  { key: "cassette", label: "Cassette", center: 2068.11, centerY: 65 },
  { key: "laptop", label: "Laptop", center: 2135.73, centerY: 63.75 },
  { key: "alien", label: "Ghost", center: 2200.73, centerY: 62 },
  { key: "puzzle", label: "Puzzle piece", center: 2264.73, centerY: 59.62 },
  { key: "horse", label: "Horse", center: 2326.73, centerY: 60.62 },
  { key: "trophy", label: "Trophy", center: 2386.1, centerY: 63.37 },
  { key: "feather", label: "Corn", center: 2441.1, centerY: 62.75 },
  { key: "roller-skate", label: "Roller skate", center: 2495.98, centerY: 59.62 },
  { key: "film-strip", label: "Film strip", center: 2553.23, centerY: 62 },
  { key: "magic-wand", label: "Magic wand", center: 2609.73, centerY: 62.87 },
  { key: "playground-slide", label: "Jersey", center: 2659.22, centerY: 62.37 },
  { key: "shopping-cart", label: "Shopping cart", center: 2710.6, centerY: 62.37 },
  { key: "barber-pole", label: "Barber pole", center: 2755.6, centerY: 63.25 },
  { key: "knitting", label: "Knitting", center: 2803.22, centerY: 64.12 },
  { key: "fork-knife", label: "Fork and knife", center: 2856.47, centerY: 64.87 },
  { key: "unicorn", label: "Unicorn", center: 2915.85, centerY: 64.37 },
  { key: "night-owl", label: "Night owl", center: 2977.97, centerY: 63.37 },
  { key: "camera", label: "Camera", center: 3041.97, centerY: 64.12 },
  { key: "vintage-shirt", label: "Vintage shirt", center: 3103.72, centerY: 64.12 }
];
